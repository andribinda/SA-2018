  ...
  <div class="row">
    <div class="col-sm-2 sidebar h-100">
      <ul class="nav flex-sm-column sideNav justify-content-center">
        ...
        <a href="#" class="sideNavItem"><i data-eva="settings-2" data-eva-height="48" data-eva-width="48"></i></a>
        <a href="#" class="sideNavItem"><i data-eva="power" data-eva-height="48" data-eva-width="48"></i></a>
        <a href="#" class="sideNavItem"><i data-eva="question-mark" data-eva-height="48" data-eva-width="48"></i></a>
      </ul>
      </div>
